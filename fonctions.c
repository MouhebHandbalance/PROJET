...
/**
* @file fonctions.c
* @brief Fichier Pour integration des taches
* @author yassine
* @version 0.1
* @date Apr 25, 2022
*/
...
{                                  
  ...
  SDL_Surface *Image_PlaySurface = NULL;                               SDL_Surface *txtminijeu = NULL;
  ...
  SDL_Rect PositionButtonBackgroundQuitSurEcran;                       SDL_Rect PositiontxtminijeuSurEcran;
...
//Creation de la fenetre
    ...
    Image_Background = IMG_Load("/home/yassine/PROJET/src/Images/BackgroundPrincipal.jpg");
    ...
    Image_xd = IMG_Load("/home/yassine/PROJET/src/Images/xd.jpg");
    if(Image_xd == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_FreeSurface(Texte);
    ...
    Image_PlayButtonBackground = IMG_Load("/home/yassine/PROJET/src/Images/ButtonBackground1.png");
    ...
    Image_OptionsButtonBackground = IMG_Load("/home/yassine/PROJET/src/Images/ButtonBackground2.png");
    ...
    Image_QuitButtonBackground = IMG_Load("/home/yassine/PROJET/src/Images/ButtonBackground3.png");
...
Image_PlaySurface = IMG_Load("/home/yassine/PROJET/src/Images/PlaySurface.png");
    ...
    Image_Lantern1 = IMG_Load("/home/yassine/PROJET/src/Images/Lantern1.png");
    ...
    Image_Lantern2 = IMG_Load("/home/yassine/PROJET/src/Images/Lantern2.png");
    ...
    Image_SbouiJeu = IMG_Load("/home/yassine/PROJET/src/Images/SbouiJeu.png");
    ...
    Image_ff = IMG_Load("/home/yassine/PROJET/src/Images/ff.png");
    if(Image_ff == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_FreeSurface(Texte);
    ...
    Volume1 = IMG_Load("/home/yassine/PROJET/src/Images/Volume1.png");
    if(Volume1 == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_FreeSurface(Texte);
    ...
    Volume2 = IMG_Load("/home/yassine/PROJET/src/Images/Volume2.png");
    if(Volume2 == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_FreeSurface(Texte);
   ...
   Volume3 = IMG_Load("/home/yassine/PROJET/src/Images/Volume3.png");
    if(Volume3 == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_FreeSurface(Texte);
   ...
   CarreauFullScreen = IMG_Load("/home/yassine/PROJET/src/Images/hi.png");
    ...
    BoutonVolume1 = IMG_Load("/home/yassine/PROJET/src/Images/BoutonVolume1.png");
    ...
    BoutonVolume2 = IMG_Load("/home/yassine/PROJET/src/Images/BoutonVolume2.png");
    ...
    Image_fd = IMG_Load("/home/yassine/PROJET/src/Images/SbouiJeu.png");
    if(Image_fd == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_FreeSurface(Texte);
    ...
    Image_Corone = IMG_Load("/home/yassine/PROJET/src/Images/kinggpng.png");
    ...
    txt = TTF_RenderText_Blended(policetxt, "!BEST PLAYER!", CouleurNoire);
    ...
    policetxtnext = TTF_OpenFont("f.ttf",40);
  txtminijeu = TTF_RenderText_Blended(policetxtnext, "QUICK GAME", CouleurNoire);
  policetxtnext = TTF_OpenFont("f.ttf",40);
...
// Boucle de l'ouverture du fenetre
     while(program_launched && t == 0)
     {
        ...
        PositionTexteOptionsSurEcran.x = 540;                                                                    PositiontxtminijeuSurEcran.x = 20;
        PositionTexteOptionsSurEcran.y = 100;                                                                    PositiontxtminijeuSurEcran.y = 800;
        ...
        SDL_BlitSurface(txtminijeu, NULL, screen, &PositiontxtminijeuSurEcran);
...
SDL_PollEvent(&event);
       ...
       case SDL_MOUSEMOTION: //printf("%d | %d \n", event.motion.x, event.motion.y);
              ...
              //Bouton PLAY
               ...
               {Image_PlayButtonBackground = IMG_Load("/home/yassine/PROJET/src/Images/ff.png");
               ...
               {
                 Image_OptionsButtonBackground = IMG_Load("/home/yassine/PROJET/src/Images/ff.png");
                 SDL_BlitSurface(Image_OptionsButtonBackground, NULL, screen, &PositionButtonBackgroundOptionsSurEcran);
                 FoisDeRepetition--;
                 while(FoisDeRepetition == 1) {SonBrefClick = Mix_LoadWAV("SonBrefClick.wav"); Mix_PlayChannel(-1, SonBrefClick, 0); FoisDeRepetition++;}
                 policeOptionsButton = TTF_OpenFont("paze.ttf",40);
               ...
               {
                 Image_QuitButtonBackground = IMG_Load("/home/yassine/PROJET/src/Images/ff.png");
                 SDL_BlitSurface(Image_QuitButtonBackground, NULL, screen, & PositionButtonBackgroundQuitSurEcran);
                 FoisDeRepetition--;
                 while(FoisDeRepetition == 1) {SonBrefClick = Mix_LoadWAV("SonBrefClick.wav"); Mix_PlayChannel(-1, SonBrefClick, 0); FoisDeRepetition++;}
                 policeQuitButton = TTF_OpenFont("paze.ttf",40);
      ...
      case SDL_MOUSEBUTTONDOWN:
            if(556 <= event.button.x && event.button.x<=826 && 345 <= event.button.y && event.button.y <=392)   //Ouverture du fenetre Pour Jouer le Jeu  
              ...
              // Liberer(&m);
               ...
               else if(26<=event.button.x && event.button.x<=302 && 818<=event.button.y && event.button.y<=856)  
               {
                 t = 10;
               }
            break;
          ...
          while(program_launched = SDL_TRUE)
                   {
                     ...
                     switch(event.type)
                     {
                       case SDL_KEYDOWN:
                          ...
                          {
                            case SDLK_f:
                            CarreauFullScreen = IMG_Load("/home/yassine/PROJET/src/Images/hello.png");
                            SDL_BlitSurface(CarreauFullScreen, NULL, screen, & PositionCarreauFullScreenSurEcran);
                            SDL_WM_ToggleFullScreen(screen);
                               break;
                           ...
                           SDL_Flip(screen);
                            ...
                            case SDLK_LEFT: 
                               ...
                               Volume3 = IMG_Load("/home/yassine/PROJET/src/Images/Volume2.png");
                               break;
                            case SDLK_DOWN:
                              Mix_VolumeMusic(MIX_MAX_VOLUME / 6);
                              Volume3 = IMG_Load("/home/yassine/PROJET/src/Images/Volume1.png");
                              break;
                            case   SDLK_UP:
                               if(Volume3 = IMG_Load("/home/yassine/PROJET/src/Images/Volume2.png"))
                               {
        ...
        while(t == 2) // interface best score
        {
              ...
              SDL_BlitSurface(MEILLEUR, NULL, screen, &postxtmeuilleur);
        ...
        while(t==300)
        {
  		...
  		{
  			InitEnigme(&e,&noomFichier);
  			afficherEnigme(e,screen, t);
  			SDL_Flip(screen);	
  		}
        } 
