...
void TicTacToe(SDL_Surface *screen)
{
  ...
  tictactoe = IMG_Load("/home/mouheb/PROJET/src/Images/TicTacToe.png");
    if(tictactoe == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
    ...
    x = IMG_Load("/home/mouheb/PROJET/src/Images/Xchose.png");
    if(x == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_Quit();
    ...
    o = IMG_Load("/home/mouheb/PROJET/src/Images/Ochose.png");
    if(o == NULL)
    {
      printf("Erreur : %s \n", SDL_GetError());
      SDL_Quit();
